 ...
 * @author andyr
 */
public class Graphics_XY extends javax.swing.JFrame {

    /**
     * Creates new form Graphics_XY
     */
    public Graphics_XY() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(pnlDraw, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, 300, 300));
        ...
        getContentPane().add(btnButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, -1, -1));
    ...
    private void drawAxis(){
        ...
        g.fillRect(0,0,Coordinate.WIDTH, Coordinate.WIDTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Graphics_XY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Graphics_XY().setVisible(true);
            }
        });
    }
